...
INSERT INTO country (id, iso, name, nicename, iso3, numcode, phonecode) VALUES
        (0,'XX','NO COUNTRY','NO COUNTRY','NOC',0,0), -- Default used when no country info available 
...
CREATE TABLE ddos_attack_logs(
        ...
        source_country_iso CHAR(2) REFERENCES COUNTRY(ISO), -- ISO is used as the foreign key reference to COUNTRY(iso)
        ...
        target_country_iso CHAR(2) REFERENCES COUNTRY(ISO), -- ISO is used as foreign key reference to COUNTRY(iso)
        ...
        severity_level VARCHAR(20) CHECK (severity_level IN ('Critical','High','Medium','Low')), -- Crititcal / High / Medium / Low 
...
CREATE INDEX idx_source_location ON ddos_attack_logs USING GIST(source_location);
...
INSERT INTO ddos_attack_logs (
        ...
        ('203.0.113.10'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(120.1551, 30.2875), 4326)::GEOGRAPHY, TRUE, 'CN', 'Hangzhou', 9808, 'China Telecom', '198.51.100.1'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-74.0060, 40.7128), 4326)::GEOGRAPHY, TRUE, 'US', 'New York', 15169, 'HTTP', 80, NOW() - INTERVAL '2 hours', TRUE, 'SYN Flood', 'Transport Layer', 'Critical', 95, 5000000, 2500000000, 8000, 2000, 'Firewall', 'IP blocked', TRUE, 'cloudflare'),
        ('185.10.45.50'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(37.6173, 55.7558), 4326)::GEOGRAPHY, TRUE, 'RU', 'Moscow', 12389, 'Rostelecom', '192.0.2.100'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-0.1278, 51.5074), 4326)::GEOGRAPHY, TRUE, 'GB', 'London', 2856, 'DNS', 53, NOW() - INTERVAL '1.5 hours', TRUE, 'UDP Flood', 'Network Layer', 'High', 88, 3000000, 1500000000, 5000, 1500, 'IDS', 'Rate limited', FALSE, 'abuseIPDB'),
        ('210.212.45.30'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(77.2090, 28.6139), 4326)::GEOGRAPHY, TRUE, 'IN', 'New Delhi', 9829, 'BSNL', '203.0.113.200'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(139.6503, 35.6762), 4326)::GEOGRAPHY, TRUE, 'JP', 'Tokyo', 2516, 'HTTPS', 443, NOW() - INTERVAL '45 minutes', TRUE, 'HTTP Flood', 'Application Layer', 'High', 82, 2500000, 1200000000, 6500, 1800, 'WAF', 'IP blocked', TRUE, 'cloudflare'),
        ('187.56.78.40'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-51.9253, -14.2350), 4326)::GEOGRAPHY, TRUE, 'BR', 'Brasília', 27699, 'Vivo', '192.0.2.50'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(13.4050, 52.5200), 4326)::GEOGRAPHY, TRUE, 'DE', 'Berlin', 3320, 'DNS', 53, NOW() - INTERVAL '30 minutes', TRUE, 'DNS Amplification', 'Network Layer', 'Medium', 75, 1500000, 800000000, 4000, 1000, 'IDS', 'Rate limited', FALSE, 'custom'),
        ('203.123.45.67'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(74.3587, 31.5204), 4326)::GEOGRAPHY, TRUE, 'PK', 'Lahore', 17974, 'PTCL', '198.51.100.150'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(151.2093, -33.8688), 4326)::GEOGRAPHY, TRUE, 'AU', 'Sydney', 1221, 'ICMP', 0, NOW() - INTERVAL '20 minutes', TRUE, 'ICMP Flood', 'Network Layer', 'Medium', 70, 1200000, 600000000, 3500, 800, 'Firewall', 'Monitored', FALSE, 'abuseIPDB'),
        ('89.163.145.25'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(30.5238, 50.4501), 4326)::GEOGRAPHY, TRUE, 'UA', 'Kyiv', 13110, 'Kyivstar', '192.0.2.200'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-79.3957, 43.6629), 4326)::GEOGRAPHY, TRUE, 'CA', 'Toronto', 6939, 'HTTP', 80, NOW() - INTERVAL '15 minutes', TRUE, 'SYN Flood', 'Transport Layer', 'High', 85, 4000000, 2000000000, 7000, 1700, 'Firewall', 'Rate limited', TRUE, 'cloudflare'),
        ('139.192.45.88'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(113.9213, -6.1256), 4326)::GEOGRAPHY, TRUE, 'ID', 'Jakarta', 7713, 'Telkom', '203.0.113.75'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(2.3522, 48.8566), 4326)::GEOGRAPHY, TRUE, 'FR', 'Paris', 3352, 'HTTPS', 443, NOW() - INTERVAL '10 minutes', TRUE, 'HTTP Flood', 'Application Layer', 'Critical', 92, 6000000, 3000000000, 9000, 2500, 'WAF', 'IP blocked', TRUE, 'cloudflare'),
        ('115.84.178.23'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(105.8342, 21.0285), 4326)::GEOGRAPHY, TRUE, 'VN', 'Hanoi', 45839, 'Viettel', '192.0.2.120'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-3.7038, 40.4168), 4326)::GEOGRAPHY, TRUE, 'ES', 'Madrid', 3333, 'DNS', 53, NOW() - INTERVAL '25 minutes', TRUE, 'UDP Flood', 'Network Layer', 'Medium', 72, 1800000, 900000000, 4500, 1200, 'IDS', 'Monitored', FALSE, 'abuseIPDB'),
        ('203.151.47.10'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(100.5018, 13.7563), 4326)::GEOGRAPHY, TRUE, 'TH', 'Bangkok', 23969, 'True Internet', '198.51.100.80'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(5.2913, 52.1326), 4326)::GEOGRAPHY, TRUE, 'NL', 'Amsterdam', 1136, 'DNS', 53, NOW() - INTERVAL '5 minutes', TRUE, 'DNS Amplification', 'Network Layer', 'Low', 55, 500000, 250000000, 1500, 400, 'IDS', 'Rate limited', FALSE, 'custom'),
        ('203.79.45.120'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(101.6869, 3.1390), 4326)::GEOGRAPHY, TRUE, 'MY', 'Kuala Lumpur', 17909, 'Maxis', '192.0.2.99'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(103.8198, 1.3521), 4326)::GEOGRAPHY, TRUE, 'SG', 'Singapore', 38040, 'HTTP', 80, NOW() - INTERVAL '35 minutes', TRUE, 'SYN Flood', 'Transport Layer', 'High', 80, 3500000, 1750000000, 6000, 1500, 'Firewall', 'IP blocked', TRUE, 'cloudflare'),
        ('196.218.73.45'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(30.0444, 31.2357), 4326)::GEOGRAPHY, TRUE, 'EG', 'Cairo', 8452, 'Etisalat Egypt', '203.0.113.55'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(46.6753, 24.7136), 4326)::GEOGRAPHY, TRUE, 'SA', 'Riyadh', 49605, 'HTTPS', 443, NOW() - INTERVAL '8 minutes', TRUE, 'HTTP Flood', 'Application Layer', 'High', 84, 2800000, 1400000000, 5500, 1600, 'WAF', 'IP blocked', TRUE, 'abuseIPDB'),
        ('187.163.12.89'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-87.3382, 19.4326), 4326)::GEOGRAPHY, TRUE, 'MX', 'Cancun', 28403, 'Telcel', '198.51.100.200'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-58.3816, -34.6037), 4326)::GEOGRAPHY, TRUE, 'AR', 'Buenos Aires', 22652, 'ICMP', 0, NOW() - INTERVAL '18 minutes', TRUE, 'ICMP Flood', 'Network Layer', 'Low', 60, 700000, 350000000, 2000, 500, 'Firewall', 'Monitored', FALSE, 'custom'),
        ('212.156.78.34'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(28.9784, 41.0082), 4326)::GEOGRAPHY, TRUE, 'TR', 'Istanbul', 12400, 'Turk Telekom', '192.0.2.77'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(23.7275, 37.9838), 4326)::GEOGRAPHY, TRUE, 'GR', 'Athens', 6799, 'DNS', 53, NOW() - INTERVAL '12 minutes', TRUE, 'UDP Flood', 'Network Layer', 'Medium', 68, 1400000, 700000000, 3800, 950, 'IDS', 'Rate limited', FALSE, 'abuseIPDB'),
        ('210.89.45.67'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(126.9780, 37.5665), 4326)::GEOGRAPHY, TRUE, 'KR', 'Seoul', 3786, 'KT Corporation', '203.0.113.111'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(121.0437, 14.5995), 4326)::GEOGRAPHY, TRUE, 'PH', 'Manila', 9299, 'HTTP', 80, NOW() - INTERVAL '22 minutes', TRUE, 'SYN Flood', 'Transport Layer', 'Critical', 90, 4500000, 2250000000, 7500, 1900, 'Firewall', 'IP blocked', TRUE, 'cloudflare'),
        ('178.45.123.56'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(21.0122, 52.2297), 4326)::GEOGRAPHY, TRUE, 'PL', 'Warsaw', 12830, 'Play', '198.51.100.160'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(12.4964, 41.9028), 4326)::GEOGRAPHY, TRUE, 'IT', 'Rome', 6762, 'HTTPS', 443, NOW() - INTERVAL '7 minutes', TRUE, 'HTTP Flood', 'Application Layer', 'High', 83, 3200000, 1600000000, 6200, 1700, 'WAF', 'IP blocked', TRUE, 'cloudflare'),
        ('197.210.78.45'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(25.7461, -28.0473), 4326)::GEOGRAPHY, TRUE, 'ZA', 'Johannesburg', 36987, 'Vodacom', '192.0.2.88'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(36.8219, -1.2921), 4326)::GEOGRAPHY, TRUE, 'KE', 'Nairobi', 37154, 'DNS', 53, NOW() - INTERVAL '3 minutes', TRUE, 'DNS Amplification', 'Network Layer', 'Low', 50, 400000, 200000000, 1200, 300, 'IDS', 'Monitored', FALSE, 'custom'),
        ('190.56.34.78'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-74.0721, 4.7110), 4326)::GEOGRAPHY, TRUE, 'CO', 'Bogota', 8452, 'Claro', '203.0.113.222'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-70.6693, -33.4489), 4326)::GEOGRAPHY, TRUE, 'CL', 'Santiago', 16626, 'ICMP', 0, NOW() - INTERVAL '28 minutes', TRUE, 'ICMP Flood', 'Network Layer', 'Medium', 65, 1100000, 550000000, 3000, 700, 'Firewall', 'Rate limited', FALSE, 'abuseIPDB'),
        ('212.81.45.90'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(18.0686, 59.3293), 4326)::GEOGRAPHY, TRUE, 'SE', 'Stockholm', 1257, 'Telia', '198.51.100.44'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(24.9354, 60.1695), 4326)::GEOGRAPHY, TRUE, 'FI', 'Helsinki', 3352, 'DNS', 53, NOW() - INTERVAL '40 minutes', TRUE, 'UDP Flood', 'Network Layer', 'Low', 58, 900000, 450000000, 2500, 600, 'IDS', 'Monitored', FALSE, 'custom'),
        ('158.39.78.12'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(10.7522, 59.9139), 4326)::GEOGRAPHY, TRUE, 'NO', 'Oslo', 2116, 'Telenor', '192.0.2.66'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(12.5683, 55.6761), 4326)::GEOGRAPHY, TRUE, 'DK', 'Copenhagen', 16509, 'HTTPS', 443, NOW() - INTERVAL '11 minutes', TRUE, 'HTTP Flood', 'Application Layer', 'Medium', 71, 2100000, 1050000000, 4200, 1100, 'WAF', 'Rate limited', TRUE, 'cloudflare'),
        ('203.89.34.56'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(114.1095, 22.3193), 4326)::GEOGRAPHY, TRUE, 'HK', 'Hong Kong', 9269, 'HKBN', '203.0.113.99'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(121.5090, 25.0443), 4326)::GEOGRAPHY, TRUE, 'TW', 'Taipei', 3462, 'HTTP', 80, NOW() - INTERVAL '33 minutes', TRUE, 'SYN Flood', 'Transport Layer', 'High', 79, 3300000, 1650000000, 5500, 1400, 'Firewall', 'IP blocked', TRUE, 'abuseIPDB'),
        ('160.5.163.77'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-94.7522, -78.4304), 4326)::GEOGRAPHY, TRUE, 'SE', 'City C', 53489, 'ISP3', '208.149.231.106'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(101.6198, 47.3273), 4326)::GEOGRAPHY, TRUE, 'DZ', 'Target City C', 61852, 'FTP', 21, NOW() - INTERVAL '5 days 12 hours 16 minutes', TRUE, 'SYN Flood', 'Transport Layer', 'Medium', 94, 1244056, 1989245544, 12763, 3596, 'IDS', 'Monitored', true, 'custom'),
        ('70.202.47.196'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(154.6251, -58.6963), 4326)::GEOGRAPHY, TRUE, 'TH', 'City B', 42915, 'ISP1', '255.86.74.3'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-12.586, 74.9836), 4326)::GEOGRAPHY, TRUE, 'GM', 'Target City B', 38469, 'HTTPS', 443, NOW() - INTERVAL '6 days 3 hours 16 minutes', TRUE, 'NTP Amplification', 'Transport Layer', 'Medium', 68, 1217955, 1153403385, 49086, 1982, 'Firewall', 'Rate limited', false, 'shodan'),
        ('168.7.178.38'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(49.5164, 84.8164), 4326)::GEOGRAPHY, TRUE, 'GM', 'City E', 8385, 'ISP1', '193.249.255.191'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(2.9638, -7.6116), 4326)::GEOGRAPHY, TRUE, 'FI', 'Target City B', 21303, 'SNMP', 161, NOW() - INTERVAL '0 days 10 hours 36 minutes', TRUE, 'HTTP Flood', 'Application Layer', 'Critical', 83, 3366394, 3679468642, 25209, 1034, 'IDS', 'Traffic filtered', false, 'shodan'),
        ('11.135.101.201'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-30.5102, 26.0273), 4326)::GEOGRAPHY, TRUE, 'AF', 'City D', 52444, 'ISP2', '48.231.197.217'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(61.7788, -32.6595), 4326)::GEOGRAPHY, TRUE, 'SG', 'Target City A', 30109, 'SNMP', 161, NOW() - INTERVAL '5 days 4 hours 19 minutes', TRUE, 'NTP Amplification', 'Network Layer', 'High', 78, 528558, 276964392, 3436, 4265, 'WAF', 'Monitored', false, 'custom'),
        ('163.142.166.51'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-89.0641, -1.6175), 4326)::GEOGRAPHY, TRUE, 'IT', 'City C', 33483, 'ISP1', '75.37.166.174'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-84.3897, -55.36), 4326)::GEOGRAPHY, TRUE, 'RU', 'Target City A', 12343, 'HTTPS', 443, NOW() - INTERVAL '2 days 13 hours 24 minutes', TRUE, 'DNS Amplification', 'Application Layer', 'High', 75, 4869993, 8293598079, 6563, 4409, 'IDS', 'Traffic filtered', true, 'shodan'),
        ('11.27.198.179'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-26.6191, -53.6186), 4326)::GEOGRAPHY, TRUE, 'NO', 'City D', 50330, 'ISP3', '101.171.72.181'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-94.3755, 66.1031), 4326)::GEOGRAPHY, TRUE, 'PK', 'Target City A', 29698, 'SSH', 22, NOW() - INTERVAL '2 days 19 hours 57 minutes', TRUE, 'ICMP Flood', 'Application Layer', 'High', 64, 5264021, 3447933755, 13392, 3768, 'Firewall', 'Traffic filtered', true, 'abuseIPDB'),
        ('76.152.58.193'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-156.683, -36.2404), 4326)::GEOGRAPHY, TRUE, 'AL', 'City B', 11889, 'ISP2', '61.56.27.192'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(73.9267, -59.8898), 4326)::GEOGRAPHY, TRUE, 'KR', 'Target City B', 54768, 'SSH', 22, NOW() - INTERVAL '6 days 15 hours 3 minutes', TRUE, 'ICMP Flood', 'Transport Layer', 'Medium', 88, 3442483, 6334168720, 15498, 3690, 'WAF', 'Traffic filtered', true, 'custom'),
        ('167.45.39.122'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(15.3899, 72.1114), 4326)::GEOGRAPHY, TRUE, 'FI', 'City C', 14685, 'ISP4', '219.152.112.222'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(41.8332, -8.3104), 4326)::GEOGRAPHY, TRUE, 'PK', 'Target City A', 13485, 'NTP', 123, NOW() - INTERVAL '0 days 2 hours 34 minutes', TRUE, 'SYN Flood', 'Application Layer', 'High', 87, 9234727, 18109299647, 9635, 797, 'Firewall', 'IP blocked', false, 'custom'),
        ('150.176.184.101'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(107.397, -86.6503), 4326)::GEOGRAPHY, TRUE, 'TO', 'City A', 57389, 'ISP1', '53.82.240.182'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(75.8216, -21.9711), 4326)::GEOGRAPHY, TRUE, 'SE', 'Target City A', 62515, 'NTP', 123, NOW() - INTERVAL '6 days 0 hours 56 minutes', TRUE, 'UDP Flood', 'Network Layer', 'Medium', 94, 611505, 489815505, 6219, 231, 'IDS', 'Rate limited', false, 'shodan'),
        ('2.251.207.187'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(71.7093, -4.2435), 4326)::GEOGRAPHY, TRUE, 'BR', 'City C', 54254, 'ISP1', '169.215.241.34'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(146.8787, 84.2114), 4326)::GEOGRAPHY, TRUE, 'PL', 'Target City B', 51188, 'FTP', 21, NOW() - INTERVAL '3 days 18 hours 52 minutes', TRUE, 'DNS Amplification', 'Network Layer', 'Critical', 72, 4839140, 5598884980, 30394, 2487, 'ML Model', 'Rate limited', true, 'cloudflare'),
        ('210.164.6.96'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-59.4754, -57.7833), 4326)::GEOGRAPHY, TRUE, 'AR', 'City A', 31894, 'ISP4', '241.242.161.182'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-67.339, -87.6348), 4326)::GEOGRAPHY, TRUE, 'ZA', 'Target City B', 16048, 'SMTP', 25, NOW() - INTERVAL '7 days 23 hours 7 minutes', TRUE, 'ICMP Flood', 'Network Layer', 'High', 81, 8610067, 5613763684, 25649, 1158, 'ML Model', 'Rate limited', false, 'cloudflare'),
        ('232.42.206.245'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(172.6562, 40.6538), 4326)::GEOGRAPHY, TRUE, 'AF', 'City D', 33951, 'ISP4', '173.171.133.30'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-61.4606, -27.6901), 4326)::GEOGRAPHY, TRUE, 'TH', 'Target City C', 10701, 'NTP', 123, NOW() - INTERVAL '5 days 21 hours 7 minutes', TRUE, 'SYN Flood', 'Application Layer', 'Low', 59, 7430471, 14036159719, 26331, 656, 'IDS', 'Traffic filtered', false, 'custom'),
        ('19.81.135.196'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-27.7412, 57.7989), 4326)::GEOGRAPHY, TRUE, 'IT', 'City B', 47396, 'ISP2', '207.218.208.228'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(49.508, -30.5245), 4326)::GEOGRAPHY, TRUE, 'HK', 'Target City C', 14213, 'NTP', 123, NOW() - INTERVAL '4 days 1 hours 35 minutes', TRUE, 'NTP Amplification', 'Transport Layer', 'High', 75, 2999646, 5093398908, 7837, 637, 'ML Model', 'Monitored', true, 'shodan'),
        ('82.124.175.150'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-89.7631, -38.408), 4326)::GEOGRAPHY, TRUE, 'ID', 'City D', 57726, 'ISP2', '248.39.38.195'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-152.3706, -57.01), 4326)::GEOGRAPHY, TRUE, 'RU', 'Target City B', 18690, 'FTP', 21, NOW() - INTERVAL '3 days 10 hours 10 minutes', TRUE, 'NTP Amplification', 'Application Layer', 'Medium', 65, 6481211, 5774759001, 45276, 4592, 'ML Model', 'Rate limited', true, 'shodan'),
        ('189.66.213.250'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-154.0547, -72.4977), 4326)::GEOGRAPHY, TRUE, 'AF', 'City A', 39693, 'ISP1', '13.33.120.68'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-66.4835, 8.4012), 4326)::GEOGRAPHY, TRUE, 'TR', 'Target City B', 32948, 'SSH', 22, NOW() - INTERVAL '4 days 5 hours 16 minutes', TRUE, 'NTP Amplification', 'Network Layer', 'High', 90, 7251140, 9049422720, 48533, 1163, 'ML Model', 'IP blocked', true, 'cloudflare'),
        ('228.177.82.189'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(120.407, 29.5018), 4326)::GEOGRAPHY, TRUE, 'IN', 'City B', 26996, 'ISP3', '129.36.119.106'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(100.4592, -71.4407), 4326)::GEOGRAPHY, TRUE, 'ID', 'Target City C', 22980, 'FTP', 21, NOW() - INTERVAL '5 days 7 hours 25 minutes', TRUE, 'DNS Amplification', 'Network Layer', 'Critical', 73, 7694659, 5409345277, 11981, 1252, 'ML Model', 'Monitored', false, 'cloudflare'),
        ('138.129.50.189'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-177.2019, 35.1737), 4326)::GEOGRAPHY, TRUE, 'GB', 'City E', 36697, 'ISP3', '115.21.94.56'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-59.5432, 46.3366), 4326)::GEOGRAPHY, TRUE, 'IN', 'Target City C', 15971, 'FTP', 21, NOW() - INTERVAL '0 days 9 hours 25 minutes', TRUE, 'SYN Flood', 'Transport Layer', 'Medium', 62, 9948355, 13569556220, 12506, 4789, 'ML Model', 'IP blocked', false, 'shodan'),
        ('100.16.139.221'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-104.0784, 82.0795), 4326)::GEOGRAPHY, TRUE, 'MX', 'City A', 6522, 'ISP1', '190.12.172.98'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(109.9306, -75.7455), 4326)::GEOGRAPHY, TRUE, 'DE', 'Target City C', 57700, 'SMTP', 25, NOW() - INTERVAL '0 days 20 hours 23 minutes', TRUE, 'NTP Amplification', 'Network Layer', 'Medium', 82, 2204030, 2091624470, 1671, 4467, 'Firewall', 'Rate limited', true, 'custom'),
        ('13.164.18.180'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(32.975, 80.0703), 4326)::GEOGRAPHY, TRUE, 'SK', 'City D', 61232, 'ISP2', '4.136.22.201'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-119.3288, 61.482), 4326)::GEOGRAPHY, TRUE, 'CO', 'Target City B', 19020, 'SNMP', 161, NOW() - INTERVAL '5 days 10 hours 33 minutes', TRUE, 'DNS Amplification', 'Application Layer', 'Medium', 50, 1413936, 1344653136, 5436, 1437, 'IDS', 'Rate limited', false, 'shodan'),
        ('14.218.71.207'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-24.8221, 63.9884), 4326)::GEOGRAPHY, TRUE, 'SK', 'City A', 39108, 'ISP1', '214.237.229.190'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-12.0645, 34.7814), 4326)::GEOGRAPHY, TRUE, 'KE', 'Target City A', 24560, 'SSH', 22, NOW() - INTERVAL '7 days 1 hours 25 minutes', TRUE, 'HTTP Flood', 'Network Layer', 'Critical', 80, 4077250, 3612443500, 23885, 171, 'IDS', 'IP blocked', false, 'custom'),
        ('92.247.29.174'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-82.6214, 55.0457), 4326)::GEOGRAPHY, TRUE, 'JP', 'City E', 58323, 'ISP3', '205.66.103.242'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(44.5018, 64.7168), 4326)::GEOGRAPHY, TRUE, 'DZ', 'Target City C', 37720, 'SMTP', 25, NOW() - INTERVAL '7 days 0 hours 44 minutes', TRUE, 'UDP Flood', 'Application Layer', 'Medium', 67, 3061521, 2363494212, 27972, 4158, 'Firewall', 'Rate limited', false, 'abuseIPDB'),
        ('81.241.123.243'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-91.2149, 35.3485), 4326)::GEOGRAPHY, TRUE, 'KE', 'City D', 13267, 'ISP1', '78.135.21.197'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(14.3856, -34.9541), 4326)::GEography, TRUE, 'RS', 'Target City A', 15190, 'SNMP', 161, NOW() - INTERVAL '5 days 6 hours 51 minutes', TRUE, 'SYN Flood', 'Application Layer', 'Low', 78, 6273726, 3613666176, 34727, 4214, 'Firewall', 'Traffic filtered', true, 'abuseIPDB'),
        ('221.64.126.33'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-159.697, -63.0909), 4326)::GEOGRAPHY, TRUE, 'PL', 'City A', 62448, 'ISP3', '166.122.110.246'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(89.4634, 67.1124), 4326)::GEOGRAPHY, TRUE, 'VN', 'Target City B', 62936, 'HTTPS', 443, NOW() - INTERVAL '0 days 5 hours 23 minutes', TRUE, 'DNS Amplification', 'Application Layer', 'Critical', 66, 4375791, 6878743452, 5159, 656, 'IDS', 'Monitored', true, 'cloudflare'),
        ('201.69.22.74'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(35.4154, -31.147), 4326)::GEOGRAPHY, TRUE, 'SI', 'City B', 12723, 'ISP4', '224.147.145.41'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-63.3524, 83.636), 4326)::GEOGRAPHY, TRUE, 'HK', 'Target City B', 18887, 'SNMP', 161, NOW() - INTERVAL '3 days 23 hours 59 minutes', TRUE, 'UDP Flood', 'Transport Layer', 'Medium', 90, 9211124, 11255993528, 10712, 2152, 'Firewall', 'Rate limited', false, 'cloudflare'),
        ('202.231.210.32'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-127.9407, 38.1646), 4326)::GEOGRAPHY, TRUE, 'TO', 'City D', 35701, 'ISP1', '138.68.14.108'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-168.1812, 88.149), 4326)::GEOGRAPHY, TRUE, 'RU', 'Target City B', 27371, 'SNMP', 161, NOW() - INTERVAL '6 days 9 hours 54 minutes', TRUE, 'DNS Amplification', 'Network Layer', 'Low', 73, 4126963, 3710139737, 20792, 1488, 'ML Model', 'IP blocked', true, 'abuseIPDB'),
        ('245.50.227.66'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-110.4126, -15.6523), 4326)::GEOGRAPHY, TRUE, 'TR', 'City A', 8664, 'ISP1', '247.92.255.192'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(76.1156, 77.8129), 4326)::GEOGRAPHY, TRUE, 'RS', 'Target City A', 31002, 'DNS', 53, NOW() - INTERVAL '3 days 17 hours 52 minutes', TRUE, 'DNS Amplification', 'Application Layer', 'Medium', 55, 6773268, 13045314168, 17649, 3233, 'IDS', 'Rate limited', true, 'shodan'),
        ('255.136.172.196'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(49.8797, -13.2705), 4326)::GEOGRAPHY, TRUE, 'FI', 'City E', 10118, 'ISP3', '6.227.170.235'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(161.3523, 30.942), 4326)::GEOGRAPHY, TRUE, 'SK', 'Target City A', 48047, 'NTP', 123, NOW() - INTERVAL '5 days 6 hours 9 minutes', TRUE, 'ICMP Flood', 'Network Layer', 'High', 72, 3177183, 3031032582, 44299, 1140, 'Firewall', 'Traffic filtered', true, 'abuseIPDB'),
        ('190.55.45.82'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-90.1695, -45.2725), 4326)::GEOGRAPHY, TRUE, 'CA', 'City C', 42997, 'ISP3', '234.238.147.147'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-62.676, 20.0941), 4326)::GEOGRAPHY, TRUE, 'SI', 'Target City C', 17467, 'SSH', 22, NOW() - INTERVAL '6 days 4 hours 3 minutes', TRUE, 'DNS Amplification', 'Application Layer', 'Low', 89, 3364021, 2045324768, 28540, 4279, 'WAF', 'Rate limited', false, 'shodan'),
        ('191.185.67.215'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-111.2315, 22.4594), 4326)::GEOGRAPHY, TRUE, 'AL', 'City E', 6078, 'ISP1', '34.73.175.198'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(86.7508, -57.5961), 4326)::GEOGRAPHY, TRUE, 'SI', 'Target City A', 50634, 'NTP', 123, NOW() - INTERVAL '5 days 16 hours 34 minutes', TRUE, 'NTP Amplification', 'Network Layer', 'Critical', 61, 8349789, 11380762407, 12173, 2049, 'Firewall', 'IP blocked', true, 'shodan'),
        ('4.186.111.140'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-39.9829, -59.2167), 4326)::GEOGRAPHY, TRUE, 'GE', 'City B', 50896, 'ISP4', '5.200.159.33'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-58.3771, 14.3326), 4326)::GEOGRAPHY, TRUE, 'CN', 'Target City C', 58874, 'HTTPS', 443, NOW() - INTERVAL '6 days 19 hours 14 minutes', TRUE, 'ICMP Flood', 'Application Layer', 'Medium', 51, 891032, 1263483376, 46418, 3142, 'ML Model', 'Traffic filtered', true, 'cloudflare'),
        ('131.150.172.122'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-93.7311, -66.0746), 4326)::GEOGRAPHY, TRUE, 'CA', 'City C', 64792, 'ISP1', '106.219.40.254'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(42.1367, 72.8899), 4326)::GEOGRAPHY, TRUE, 'HK', 'Target City A', 36515, 'SMTP', 25, NOW() - INTERVAL '4 days 6 hours 31 minutes', TRUE, 'ICMP Flood', 'Network Layer', 'Critical', 53, 5480190, 5332224870, 47719, 992, 'IDS', 'Monitored', false, 'abuseIPDB'),
        ('188.147.148.163'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(156.3995, 50.3299), 4326)::GEOGRAPHY, TRUE, 'KE', 'City A', 9647, 'ISP2', '200.96.154.24'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-58.6371, 50.2456), 4326)::GEOGRAPHY, TRUE, 'TO', 'Target City C', 25807, 'FTP', 21, NOW() - INTERVAL '7 days 13 hours 54 minutes', TRUE, 'UDP Flood', 'Application Layer', 'High', 68, 7659430, 5805847940, 11768, 4005, 'ML Model', 'Monitored', false, 'shodan'),
        ('67.131.80.253'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-71.5819, -80.6804), 4326)::GEOGRAPHY, TRUE, 'AL', 'City D', 12482, 'ISP4', '133.219.221.87'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(107.818, 66.1173), 4326)::GEOGRAPHY, TRUE, 'GM', 'Target City A', 34859, 'NTP', 123, NOW() - INTERVAL '1 days 10 hours 12 minutes', TRUE, 'SYN Flood', 'Transport Layer', 'Critical', 77, 5992330, 9869367510, 46475, 1757, 'WAF', 'IP blocked', false, 'shodan'),
        ('119.43.245.97'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(9.5275, 10.0826), 4326)::GEOGRAPHY, TRUE, 'EG', 'City B', 52889, 'ISP4', '105.98.61.118'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-45.0567, -73.3505), 4326)::GEOGRAPHY, TRUE, 'GB', 'Target City B', 27653, 'FTP', 21, NOW() - INTERVAL '5 days 0 hours 33 minutes', TRUE, 'HTTP Flood', 'Transport Layer', 'High', 74, 9294359, 6710527198, 20206, 952, 'WAF', 'Monitored', true, 'shodan'),
        ('157.158.220.233'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(54.409, -20.3538), 4326)::GEOGRAPHY, TRUE, 'GE', 'City C', 59011, 'ISP3', '95.215.242.233'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(15.4992, -71.5766), 4326)::GEOGRAPHY, TRUE, 'JP', 'Target City A', 44601, 'HTTP', 80, NOW() - INTERVAL '7 days 0 hours 15 minutes', TRUE, 'SYN Flood', 'Network Layer', 'High', 69, 7252516, 12648387904, 8060, 4330, 'Firewall', 'Traffic filtered', true, 'custom'),
        ('35.223.241.222'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(142.1999, 9.116), 4326)::GEOGRAPHY, TRUE, 'NO', 'City B', 58669, 'ISP1', '129.21.244.178'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(154.7833, 63.1354), 4326)::GEOGRAPHY, TRUE, 'JP', 'Target City B', 60892, 'SMTP', 25, NOW() - INTERVAL '0 days 22 hours 7 minutes', TRUE, 'DNS Amplification', 'Application Layer', 'High', 86, 3287511, 5450693238, 24138, 4790, 'ML Model', 'Traffic filtered', false, 'abuseIPDB'),
        ('175.7.67.98'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(117.5023, -44.971), 4326)::GEOGRAPHY, TRUE, 'VN', 'City E', 46667, 'ISP3', '208.91.24.74'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(167.7528, -80.009), 4326)::GEOGRAPHY, TRUE, 'KR', 'Target City C', 10910, 'NTP', 123, NOW() - INTERVAL '1 days 0 hours 16 minutes', TRUE, 'HTTP Flood', 'Network Layer', 'High', 86, 3766086, 4658648382, 7962, 675, 'Firewall', 'Traffic filtered', true, 'cloudflare'),
        ('221.208.21.129'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-16.4374, 44.164), 4326)::GEOGRAPHY, TRUE, 'KE', 'City C', 8016, 'ISP1', '36.175.93.186'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-91.7916, 54.1556), 4326)::GEOGRAPHY, TRUE, 'PL', 'Target City C', 50944, 'SMTP', 25, NOW() - INTERVAL '6 days 4 hours 38 minutes', TRUE, 'HTTP Flood', 'Transport Layer', 'Medium', 75, 5874271, 4934387640, 9437, 2914, 'WAF', 'Monitored', true, 'cloudflare'),
        ('230.184.175.194'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(32.3994, 39.5519), 4326)::GEOGRAPHY, TRUE, 'FR', 'City A', 19171, 'ISP2', '51.6.84.167'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-137.919, -27.3579), 4326)::GEOGRAPHY, TRUE, 'AR', 'Target City C', 64864, 'FTP', 21, NOW() - INTERVAL '5 days 18 hours 53 minutes', TRUE, 'SYN Flood', 'Application Layer', 'Low', 55, 5873162, 8140202532, 4814, 4382, 'ML Model', 'Traffic filtered', false, 'shodan'),
        ('134.89.172.32'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-5.7258, 67.5356), 4326)::GEOGRAPHY, TRUE, 'RS', 'City C', 26338, 'ISP3', '225.20.8.145'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-145.8761, 15.8454), 4326)::GEOGRAPHY, TRUE, 'PK', 'Target City A', 38458, 'HTTPS', 443, NOW() - INTERVAL '1 days 12 hours 45 minutes', TRUE, 'ICMP Flood', 'Application Layer', 'Critical', 65, 2306416, 4419093056, 35646, 3678, 'IDS', 'Monitored', false, 'cloudflare'),
        ('48.85.107.107'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-172.0138, 42.867), 4326)::GEOGRAPHY, TRUE, 'KR', 'City C', 33027, 'ISP4', '189.103.135.95'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(174.1827, 51.3809), 4326)::GEOGRAPHY, TRUE, 'CA', 'Target City B', 25063, 'HTTPS', 443, NOW() - INTERVAL '2 days 13 hours 44 minutes', TRUE, 'UDP Flood', 'Transport Layer', 'High', 65, 2150899, 2221878667, 37220, 306, 'Firewall', 'Monitored', true, 'cloudflare'),
        ('201.24.125.53'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(29.1777, -80.9428), 4326)::GEOGRAPHY, TRUE, 'EG', 'City C', 12213, 'ISP1', '172.44.212.130'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(92.791, -12.9118), 4326)::GEOGRAPHY, TRUE, 'GE', 'Target City C', 48147, 'SSH', 22, NOW() - INTERVAL '5 days 1 hours 40 minutes', TRUE, 'SYN Flood', 'Transport Layer', 'High', 87, 7811906, 13295864012, 15501, 2942, 'Firewall', 'Monitored', true, 'cloudflare'),
        ('52.179.104.142'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-6.2804, 81.2929), 4326)::GEOGRAPHY, TRUE, 'MX', 'City E', 53326, 'ISP4', '130.24.5.170'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(141.1219, 61.9442), 4326)::GEOGRAPHY, TRUE, 'VN', 'Target City B', 56081, 'DNS', 53, NOW() - INTERVAL '5 days 10 hours 55 minutes', TRUE, 'ICMP Flood', 'Network Layer', 'High', 83, 2342081, 4154851694, 2972, 2215, 'IDS', 'IP blocked', true, 'custom'),
        ('250.189.92.229'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(98.6078, 10.1675), 4326)::GEOGRAPHY, TRUE, 'GE', 'City C', 21436, 'ISP3', '147.204.69.208'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-14.3318, -43.5693), 4326)::GEOGRAPHY, TRUE, 'SI', 'Target City C', 23192, 'SNMP', 161, NOW() - INTERVAL '6 days 2 hours 10 minutes', TRUE, 'HTTP Flood', 'Transport Layer', 'Critical', 89, 9389176, 18731406120, 21040, 2563, 'Firewall', 'Monitored', true, 'abuseIPDB'),
        ('1.91.139.247'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-50.8393, -37.3678), 4326)::GEOGRAPHY, TRUE, 'ZA', 'City E', 56459, 'ISP3', '159.174.38.204'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(39.739, 61.7259), 4326)::GEOGRAPHY, TRUE, 'KE', 'Target City A', 14138, 'HTTPS', 443, NOW() - INTERVAL '3 days 0 hours 23 minutes', TRUE, 'DNS Amplification', 'Network Layer', 'Critical', 92, 4565207, 2638689646, 43993, 766, 'ML Model', 'Rate limited', false, 'shodan'),
        ('145.146.130.239'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-39.3838, -37.8457), 4326)::GEOGRAPHY, TRUE, 'PK', 'City D', 21749, 'ISP4', '110.56.100.164'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(19.0566, 12.1759), 4326)::GEOGRAPHY, TRUE, 'IN', 'Target City B', 50379, 'FTP', 21, NOW() - INTERVAL '3 days 23 hours 58 minutes', TRUE, 'HTTP Flood', 'Application Layer', 'Critical', 91, 5604514, 3861510146, 47527, 1558, 'ML Model', 'IP blocked', false, 'shodan'),
        ('52.42.23.8'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-146.3545, -34.0581), 4326)::GEOGRAPHY, TRUE, 'CA', 'City E', 52559, 'ISP1', '68.248.199.76'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-4.5071, -51.2618), 4326)::GEOGRAPHY, TRUE, 'FI', 'Target City A', 28776, 'SNMP', 161, NOW() - INTERVAL '2 days 1 hours 31 minutes', TRUE, 'ICMP Flood', 'Transport Layer', 'High', 59, 7475286, 4574875032, 31434, 3226, 'WAF', 'Rate limited', false, 'custom'),
        ('212.128.82.125'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(114.3225, 77.9095), 4326)::GEOGRAPHY, TRUE, 'CO', 'City E', 34576, 'ISP1', '105.66.23.188'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(105.0225, -38.0579), 4326)::GEOGRAPHY, TRUE, 'US', 'Target City A', 38426, 'SSH', 22, NOW() - INTERVAL '7 days 14 hours 28 minutes', TRUE, 'NTP Amplification', 'Transport Layer', 'Critical', 70, 2590743, 2722870893, 22354, 4332, 'WAF', 'Traffic filtered', true, 'shodan'),
        ('65.195.120.154'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-114.4933, 53.6506), 4326)::GEOGRAPHY, TRUE, 'SE', 'City A', 54184, 'ISP4', '19.7.35.40'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-33.4068, -62.3334), 4326)::GEOGRAPHY, TRUE, 'SK', 'Target City B', 63051, 'HTTPS', 443, NOW() - INTERVAL '4 days 6 hours 13 minutes', TRUE, 'NTP Amplification', 'Transport Layer', 'High', 97, 9762927, 14517472449, 42216, 4785, 'Firewall', 'Rate limited', true, 'cloudflare'),
        ('150.182.58.193'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(59.1399, 14.6013), 4326)::GEOGRAPHY, TRUE, 'AL', 'City A', 38819, 'ISP3', '31.209.106.176'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(84.759, 36.2033), 4326)::GEOGRAPHY, TRUE, 'AR', 'Target City A', 38413, 'SNMP', 161, NOW() - INTERVAL '5 days 2 hours 34 minutes', TRUE, 'DNS Amplification', 'Network Layer', 'Critical', 96, 962196, 1237384056, 25756, 337, 'WAF', 'Monitored', false, 'custom'),
        ('229.5.163.77'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(52.8772, -84.3679), 4326)::GEOGRAPHY, TRUE, 'ID', 'City A', 26316, 'ISP3', '208.149.231.106'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(3.2978, 18.1988), 4326)::GEOGRAPHY, TRUE, 'DK', 'Target City C', 61852, 'SMTP', 25, NOW() - INTERVAL '23 days 17 hours 22 minutes', TRUE, 'DNS Amplification', 'Network Layer', 'Critical', 53, 4774733, 2817092470, 36171, 1570, 'IDS', 'Monitored', false, 'custom'),
        ('70.202.47.196'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(154.6251, -58.6963), 4326)::GEOGRAPHY, TRUE, 'ID', 'City B', 22443, 'ISP2', '255.86.74.3'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-12.586, 74.9836), 4326)::GEOGRAPHY, TRUE, 'GB', 'Target City C', 44162, 'SMTP', 25, NOW() - INTERVAL '23 days 20 hours 27 minutes', TRUE, 'SYN Flood', 'Network Layer', 'High', 97, 5470545, 9064693065, 6608, 450, 'Firewall', 'Monitored', true, 'shodan'),
        ('164.16.234.113'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(21.9697, -48.9049), 4326)::GEOGRAPHY, TRUE, 'DZ', 'City B', 24991, 'ISP3', '168.7.178.38'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(169.6327, 31.0698), 4326)::GEOGRAPHY, TRUE, 'EG', 'Target City C', 13472, 'HTTP', 80, NOW() - INTERVAL '24 days 17 hours 31 minutes', TRUE, 'ICMP Flood', 'Network Layer', 'Medium', 87, 6160178, 10287497260, 20969, 834, 'WAF', 'IP blocked', false, 'cloudflare'),
        ('130.212.244.163'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-20.8343, -53.5706), 4326)::GEOGRAPHY, TRUE, 'SG', 'City D', 6111, 'ISP1', '254.204.21.135'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-92.4395, -87.4833), 4326)::GEOGRAPHY, TRUE, 'IN', 'Target City A', 39320, 'DNS', 53, NOW() - INTERVAL '6 days 12 hours 11 minutes', TRUE, 'DNS Amplification', 'Network Layer', 'Low', 71, 5593348, 10895841904, 29110, 2049, 'ML Model', 'Traffic filtered', false, 'abuseIPDB'),
        ('214.129.98.120'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-85.8674, -19.2854), 4326)::GEOGRAPHY, TRUE, 'DZ', 'City D', 12149, 'ISP3', '68.4.142.166'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-99.356, -14.7219), 4326)::GEOGRAPHY, TRUE, 'MY', 'Target City C', 11563, 'SMTP', 25, NOW() - INTERVAL '3 days 9 hours 4 minutes', TRUE, 'NTP Amplification', 'Application Layer', 'Medium', 97, 3378468, 4506876312, 25882, 3527, 'IDS', 'Monitored', true, 'shodan'),
        ('110.154.32.121'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-30.9296, -72.5782), 4326)::GEOGRAPHY, TRUE, 'BR', 'City C', 10968, 'ISP2', '91.20.27.198'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-107.2373, -6.9052), 4326)::GEOGRAPHY, TRUE, 'CA', 'Target City B', 42239, 'DNS', 53, NOW() - INTERVAL '28 days 11 hours 25 minutes', TRUE, 'ICMP Flood', 'Network Layer', 'High', 72, 9422850, 18817431450, 17165, 1989, 'Firewall', 'Traffic filtered', true, 'custom'),
        ('203.80.152.143'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-179.1558, 5.9117), 4326)::GEOGRAPHY, TRUE, 'CA', 'City A', 58580, 'ISP2', '17.85.151.152'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-90.4528, 53.2466), 4326)::GEOGRAPHY, TRUE, 'MY', 'Target City C', 63027, 'HTTPS', 443, NOW() - INTERVAL '27 days 23 hours 53 minutes', TRUE, 'SYN Flood', 'Application Layer', 'Low', 65, 1400480, 2226763200, 25607, 3657, 'ML Model', 'Rate limited', false, 'abuseIPDB'),
        ('191.213.222.156'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(69.6456, -11.0966), 4326)::GEOGRAPHY, TRUE, 'US', 'City A', 41155, 'ISP1', '241.53.232.48'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-90.0215, -73.8236), 4326)::GEOGRAPHY, TRUE, 'IN', 'Target City C', 16801, 'FTP', 21, NOW() - INTERVAL '19 days 2 hours 41 minutes', TRUE, 'NTP Amplification', 'Transport Layer', 'Critical', 65, 9332170, 8865561500, 29499, 4636, 'WAF', 'Rate limited', true, 'cloudflare'),
        ('30.24.39.172'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(16.2199, -36.4193), 4326)::GEOGRAPHY, TRUE, 'PL', 'City D', 6042, 'ISP2', '192.148.131.9'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-42.9714, 4.4707), 4326)::GEOGRAPHY, TRUE, 'CO', 'Target City B', 30477, 'SSH', 22, NOW() - INTERVAL '3 days 12 hours 38 minutes', TRUE, 'NTP Amplification', 'Application Layer', 'Medium', 73, 3964782, 6252461214, 11522, 3954, 'WAF', 'IP blocked', false, 'abuseIPDB'),
        ('61.121.234.31'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-41.6702, -87.1098), 4326)::GEOGRAPHY, TRUE, 'DZ', 'City E', 59362, 'ISP4', '54.243.227.198'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-174.3892, 51.1442), 4326)::GEOGRAPHY, TRUE, 'FR', 'Target City B', 10704, 'SMTP', 25, NOW() - INTERVAL '30 days 16 hours 58 minutes', TRUE, 'UDP Flood', 'Transport Layer', 'Low', 75, 7576805, 11115172935, 5415, 4907, 'ML Model', 'Monitored', true, 'custom'),
        ('177.167.109.21'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-102.1726, -37.5365), 4326)::GEOGRAPHY, TRUE, 'KR', 'City C', 29345, 'ISP4', '223.253.91.18'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-146.2116, -29.2698), 4326)::GEOGRAPHY, TRUE, 'RU', 'Target City C', 13827, 'SMTP', 25, NOW() - INTERVAL '10 days 9 hours 0 minutes', TRUE, 'HTTP Flood', 'Network Layer', 'Critical', 90, 9662731, 5063271044, 43299, 1642, 'WAF', 'Rate limited', false, 'shodan'),
        ('226.66.238.57'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-153.1492, -2.9884), 4326)::GEOGRAPHY, TRUE, 'FR', 'City D', 37454, 'ISP3', '251.202.212.254'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(98.4255, -22.2979), 4326)::GEOGRAPHY, TRUE, 'MY', 'Target City B', 9894, 'DNS', 53, NOW() - INTERVAL '4 days 10 hours 9 minutes', TRUE, 'NTP Amplification', 'Transport Layer', 'Critical', 67, 1735798, 2096843984, 22579, 1215, 'ML Model', 'IP blocked', true, 'cloudflare'),
        ('18.209.241.218'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-38.6021, -5.0655), 4326)::GEOGRAPHY, TRUE, 'TO', 'City E', 32662, 'ISP4', '101.36.73.251'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(44.0822, 32.0885), 4326)::GEOGRAPHY, TRUE, 'US', 'Target City C', 54584, 'HTTPS', 443, NOW() - INTERVAL '8 days 13 hours 39 minutes', TRUE, 'UDP Flood', 'Network Layer', 'Critical', 71, 3182782, 3316458844, 48603, 3250, 'ML Model', 'IP blocked', false, 'cloudflare'),
        ('27.33.49.69'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(119.8548, 21.2015), 4326)::GEOGRAPHY, TRUE, 'CN', 'City B', 55227, 'ISP3', '162.94.64.131'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-126.3634, -19.0258), 4326)::GEOGRAPHY, TRUE, 'MX', 'Target City B', 11089, 'FTP', 21, NOW() - INTERVAL '29 days 10 hours 25 minutes', TRUE, 'UDP Flood', 'Transport Layer', 'Medium', 76, 3574893, 1816045644, 6029, 1587, 'Firewall', 'Traffic filtered', false, 'abuseIPDB'),
        ('92.97.41.225'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(66.3341, 71.1301), 4326)::GEOGRAPHY, TRUE, 'KR', 'City A', 54184, 'ISP2', '203.67.128.99'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-81.3573, -27.5135), 4326)::GEOGRAPHY, TRUE, 'CN', 'Target City C', 60078, 'HTTPS', 443, NOW() - INTERVAL '11 days 19 hours 54 minutes', TRUE, 'UDP Flood', 'Network Layer', 'Critical', 69, 4645931, 3005917357, 36826, 4608, 'WAF', 'Traffic filtered', false, 'cloudflare'),
        ('87.73.118.206'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-70.9622, -65.9359), 4326)::GEOGRAPHY, TRUE, 'DZ', 'City E', 64149, 'ISP3', '94.66.85.42'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(115.5005, -42.8662), 4326)::GEOGRAPHY, TRUE, 'IN', 'Target City C', 56479, 'HTTP', 80, NOW() - INTERVAL '16 days 2 hours 19 minutes', TRUE, 'DNS Amplification', 'Network Layer', 'Critical', 92, 2372827, 1843686579, 44509, 660, 'IDS', 'Monitored', true, 'cloudflare'),
        ('173.26.187.157'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-93.6463, 81.9471), 4326)::GEOGRAPHY, TRUE, 'IN', 'City C', 6605, 'ISP3', '110.50.85.72'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-89.4684, -6.9977), 4326)::GEOGRAPHY, TRUE, 'DE', 'Target City A', 55152, 'SMTP', 25, NOW() - INTERVAL '10 days 6 hours 20 minutes', TRUE, 'HTTP Flood', 'Application Layer', 'Medium', 68, 2435608, 2903244736, 9097, 4597, 'ML Model', 'Traffic filtered', true, 'cloudflare'),
        ('6.183.103.137'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(139.4784, -70.1311), 4326)::GEOGRAPHY, TRUE, 'US', 'City D', 19821, 'ISP3', '145.216.89.175'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-170.9303, 83.5904), 4326)::GEOGRAPHY, TRUE, 'CN', 'Target City A', 7761, 'DNS', 53, NOW() - INTERVAL '18 days 14 hours 57 minutes', TRUE, 'ICMP Flood', 'Application Layer', 'Medium', 85, 5843606, 3681471780, 28265, 1662, 'ML Model', 'Traffic filtered', true, 'cloudflare'),
        ('93.167.138.175'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-170.9229, -12.0515), 4326)::GEOGRAPHY, TRUE, 'ID', 'City C', 9225, 'ISP3', '27.112.5.36'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-160.3751, -55.237), 4326)::GEOGRAPHY, TRUE, 'US', 'Target City C', 8423, 'SMTP', 25, NOW() - INTERVAL '1 days 0 hours 7 minutes', TRUE, 'NTP Amplification', 'Transport Layer', 'High', 73, 6091267, 10422157837, 35072, 1428, 'ML Model', 'IP blocked', true, 'custom'),
        ('118.130.4.248'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(172.6236, 54.967), 4326)::GEOGRAPHY, TRUE, 'SE', 'City E', 62065, 'ISP4', '14.112.34.83'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-59.3367, 69.5833), 4326)::GEOGRAPHY, TRUE, 'AL', 'Target City C', 26820, 'SSH', 22, NOW() - INTERVAL '17 days 23 hours 20 minutes', TRUE, 'DNS Amplification', 'Application Layer', 'High', 74, 9766508, 7764373860, 44346, 1131, 'WAF', 'IP blocked', false, 'cloudflare'),
        ('136.229.190.242'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-34.1669, 34.1493), 4326)::GEOGRAPHY, TRUE, 'PL', 'City C', 48006, 'ISP2', '12.201.167.174'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(17.7117, -6.4365), 4326)::GEOGRAPHY, TRUE, 'CA', 'Target City A', 26088, 'HTTP', 80, NOW() - INTERVAL '3 days 15 hours 13 minutes', TRUE, 'ICMP Flood', 'Transport Layer', 'High', 72, 6755652, 3465649476, 34108, 221, 'IDS', 'IP blocked', true, 'custom'),
        ('177.174.66.103'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(44.5018, 64.7168), 4326)::GEOGRAPHY, TRUE, 'ID', 'City A', 60264, 'ISP2', '122.252.5.108'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-159.205, -26.0153), 4326)::GEOGRAPHY, TRUE, 'FR', 'Target City A', 39666, 'NTP', 123, NOW() - INTERVAL '27 days 17 hours 19 minutes', TRUE, 'HTTP Flood', 'Network Layer', 'High', 58, 8812663, 13421685749, 35917, 3093, 'IDS', 'IP blocked', false, 'custom'),
        ('173.123.243.154'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-10.111, -62.1808), 4326)::GEOGRAPHY, TRUE, 'TO', 'City A', 45141, 'ISP1', '68.21.197.178'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(63.8438, 1.23), 4326)::GEOGRAPHY, TRUE, 'TH', 'Target City A', 15190, 'HTTP', 80, NOW() - INTERVAL '6 days 3 hours 33 minutes', TRUE, 'DNS Amplification', 'Network Layer', 'Low', 72, 9134162, 13956999536, 46328, 690, 'Firewall', 'Traffic filtered', false, 'abuseIPDB'),
        ('221.64.126.33'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-159.697, -63.0909), 4326)::GEOGRAPHY, TRUE, 'DE', 'City A', 62448, 'ISP3', '166.122.110.246'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(89.4634, 67.1124), 4326)::GEOGRAPHY, TRUE, 'MY', 'Target City B', 62936, 'HTTPS', 443, NOW() - INTERVAL '1 days 5 hours 23 minutes', TRUE, 'DNS Amplification', 'Application Layer', 'Critical', 66, 4375791, 6878743452, 5159, 656, 'IDS', 'Monitored', true, 'cloudflare'),
        ('201.69.22.74'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(35.4154, -31.147), 4326)::GEOGRAPHY, TRUE, 'GB', 'City B', 12723, 'ISP4', '224.147.145.41'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-63.3524, 83.636), 4326)::GEOGRAPHY, TRUE, 'TR', 'Target City B', 18887, 'SNMP', 161, NOW() - INTERVAL '7 days 23 hours 59 minutes', TRUE, 'UDP Flood', 'Transport Layer', 'Medium', 90, 9211124, 11255993528, 10712, 2152, 'Firewall', 'Rate limited', false, 'cloudflare'),
        ('64.231.210.32'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(123.8004, -49.7665), 4326)::GEOGRAPHY, TRUE, 'JP', 'City D', 35701, 'ISP1', '138.68.14.108'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(4.1779, 35.3991), 4326)::GEOGRAPHY, TRUE, 'CO', 'Target City B', 27371, 'SNMP', 161, NOW() - INTERVAL '12 days 9 hours 54 minutes', TRUE, 'DNS Amplification', 'Network Layer', 'Low', 73, 4126963, 3710139737, 20792, 1488, 'ML Model', 'IP blocked', true, 'abuseIPDB'),
        ('63.50.227.66'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-137.4919, 24.123), 4326)::GEOGRAPHY, TRUE, 'DK', 'City A', 8664, 'ISP1', '247.92.255.192'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(25.1732, 35.6371), 4326)::GEOGRAPHY, TRUE, 'JP', 'Target City A', 31002, 'DNS', 53, NOW() - INTERVAL '25 days 18 hours 15 minutes', TRUE, 'ICMP Flood', 'Network Layer', 'Medium', 55, 6773268, 13045314168, 17649, 3233, 'IDS', 'Rate limited', true, 'shodan'),
        ('13.136.172.196'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-87.8424, 27.298), 4326)::GEOGRAPHY, TRUE, 'TO', 'City A', 46170, 'ISP1', '6.227.170.235'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-101.3427, -34.1153), 4326)::GEOGRAPHY, TRUE, 'DK', 'Target City B', 7535, 'SSH', 22, NOW() - INTERVAL '24 days 10 hours 13 minutes', TRUE, 'UDP Flood', 'Application Layer', 'Medium', 92, 6517837, 9007650734, 11457, 1918, 'Firewall', 'Traffic filtered', true, 'abuseIPDB'),
        ('190.55.45.82'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-90.1695, -45.2725), 4326)::GEOGRAPHY, TRUE, 'DZ', 'City C', 42997, 'ISP3', '234.238.147.147'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-62.676, 20.0941), 4326)::GEOGRAPHY, TRUE, 'GB', 'Target City C', 17467, 'SSH', 22, NOW() - INTERVAL '20 days 13 hours 9 minutes', TRUE, 'SYN Flood', 'Network Layer', 'Low', 89, 3364021, 2045324768, 28540, 4279, 'WAF', 'Rate limited', false, 'shodan'),
        ('191.185.67.215'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(-111.2315, 22.4594), 4326)::GEOGRAPHY, TRUE, 'AF', 'City E', 6078, 'ISP1', '34.73.175.198'::CIDR, TRUE, ST_SetSRID(ST_MakePoint(86.7508, -57.5961), 4326)::GEOGRAPHY, TRUE, 'GB', 'Target City A', 50634, 'NTP', 123, NOW() - INTERVAL '10 days 16 hours 34 minutes', TRUE, 'NTP Amplification', 'Network Layer', 'Critical', 61, 8349789, 11380762407, 12173, 2049, 'Firewall', 'IP blocked', true, 'shodan')
;
...
CREATE OR REPLACE VIEW view_ddos_attack_24hours AS 
SELECT * 
